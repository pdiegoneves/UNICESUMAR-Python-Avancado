...
def get_ativos():
    ...
    driver = webdriver.Chrome(executable_path="C:\\Users\\paulo.neves\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe", chrome_options=options)

    driver.get("https://sistemaswebb3-listadados.b3.com.br/indexPage/day/IBOV?languge=pt-br")
...
def gerando_carteira_aleatoria(percentual_acumulado):
    carteira = randon.choices(percentual_acumulado.columns, k=5)
